...
const Alert = ({ text, color, setAlertMessage = useNoteContext() }) => {
  ...
  return (
    <div className={`flex justify-between items-center px-4 py-5 z-50 fixed mb-4 rounded-lg dark:bg-gray-900 border transition-all duration-500 ease-out transform
      ...
      ${color === "red" && "bottom-1 sm:bottom-4.5 left-0 right-0 mx-auto max-w-[97%] sm:max-w-md text-red-800 bg-red-50 dark:text-red-400 border-red-400 dark:border-0"}
    `} >
