...
const Login = () => {
  ...
  const onSubmit = async (credentials) => {
    try {
      const loginURL = import.meta.env.VITE_API_BASE_URL + import.meta.env.VITE_LOGIN_ENDPOINT;
  ...
  return (
    <>
      ...
      <form className="sm:max-w-md mx-auto py-20 max-w-xs" onSubmit={handleSubmit(onSubmit)}>
        <h1 className="text-3xl sm:text-4xl font-bold ml-1 mb-8 sm:mb-10 text-gray-800 dark:text-purple-200">Login to you account</h1>
        {/* Email input */}
        <div className="mb-3">
        ...
        <div className="mb-3">
          <div className="flex items-center justify-center bg-gray-50 border border-gray-300 text-lg rounded-full focus-within:ring-purple-500 focus-within:border-purple-500 w-full px-5 dark:bg-gray-700 dark:border-gray-600 dark:focus-within:ring-purple-500 dark:focus-within:border-purple-500 transition-colors">
            <input {...register("password", {
              ...
              type={`${showPassword ? "text" : "password"}`} placeholder="Enter Password" className="py-3 bg-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 w-full outline-none transition-none items-center select-none" />
